...
class EstadoDocumentacionModel extends Model
{
    ...
    {
        $estado = $this->select('descripcion')->getWhere(['id_estado_documentacion' => $id])->getRow();
        return $estado->descripcion;
    }

    public function obtenerIdPorEstado($estado)
    {
        $id = $this->select('id_estado_documentacion')->getWhere(['descripcion' => $estado])->getRow();
        return $id->id_estado_documentacion;
    }
