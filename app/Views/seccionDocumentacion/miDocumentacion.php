                                            ...
                                            <table class="table datatable datatable-table" id="dataTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-sortable="true" style="width: 10%;"><button class="datatable-sorter">Editar</button>
                                                        </th>
                                                        <th data-sortable="true" style="width: 10%;"><button class="datatable-sorter">Pasos para la
                                                                recuperacion</button>
                                                        </th>
                                                        <th data-sortable="true" style="width: 10%;"><button class="datatable-sorter">Eliminar</button>
                                                        </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach ($data as $documento) { ?>
                                                            ...
                                                            <tr data-index="<?php $index ?>">
                                                                ...
                                                                <td>
                                                                    <button id='eliminarDocumentacion' value=<?= $documento['id'] ?> class="btn btn-success float-right">Eliminar</button>
                                                                </td>
                                                                <td>
                                                                    <label>
                                                                        ...
                                                                        <input type="checkbox" name="opciones[]" value="<?php echo $documento['id'] ?>">
                                                                        Seleccionar
                                                                    </label>
                                                                </td>
                                                            </tr>
